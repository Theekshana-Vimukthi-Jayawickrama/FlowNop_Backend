...
const seedDatabase = async () => {
    try {
        logger_1.default.info('Connecting to database for seeding...');
        await mongoose_1.default.connect(env_1.default.MONGO_URI);
        logger_1.default.info('Database connected successfully.');
        // Clear collections
        logger_1.default.info('Clearing existing users and tasks...');
        ...
        logger_1.default.info('Seeding tasks...');
        const sampleTasks = [
            {
        ...
        await Task_1.default.insertMany(sampleTasks);
        logger_1.default.info('Database seeded successfully with users and sample tasks.');
    }
    catch (error) {
